...
Scenario: Criar uma categoria
  ...
  Then o método retorna o item formatado:
    | name | itemsId |
    | "Lanches" | [] |
  And o categoryRepository foi acionado e há os itens:
    | id | name | itemsId |
    | 0  | "Promoção" | [] |
    | 1  | "Bebidas" | [1, 4] |
    | 2  | "Vegetariano" | [] |
...
Scenario: Modificar uma categoria
  ...
  """
  {
    "id": 1,
    "data": {
      "name": "Combo", "itemsId": [0, 1, 2]
    }
  }
  """
  Then o método retorna o item formatado:
    | name | itemsId |
    | "Combo" | [{"id": 0, "name": "Coca-Cola", "price": 5.00, "description": "Geladinha", "categoryID": 1, "image": "coca-cola.jpg", "timeToPrepare": 5 }, {"id": 1, "name": "Hamburguer", "price": 15.00, "description": "feito de carne", "categoryID": 5, "image": "ham.jpg", "timeToPrepare": 10 }, {"id": 2, "name": "Batata Frita", "price": 10.00, "description": "Sem Oléo", "categoryID": 4, "image": "bt.jpg", "timeToPrepare": 5 }] |
  And o CategoryRepository e MenuRepository foram acionados e há os itens:
    | id | name | itemsId |
    | 0  | "Promoção" | [] |
    | 1  | "Combo" | [0, 1, 2] |
    | 2  | "Vegetariano" | [] |
...
Scenario: Apagar uma categoria
  ...
  And o CategoryRepository é acionado e há os itens:
    | id | name | itemsId |
    | 0  | "Promoção" | [] |
    | 1  | "Bebidas" | [1, 4] |
    | 3  | "Jantar" | [] |
